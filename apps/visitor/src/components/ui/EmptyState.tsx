...
// 2026-07-07 (Phase6 UX堅牢化): register(components/ui/EmptyState.tsx) から移植。
// 一覧が0件のときの表示を共通化し、RawBlock スタイル (破線の太枠・角丸なし・mono) で
// 控えめに表示する。visitor にはこれまで存在しなかった (register 側にのみ既存)。
